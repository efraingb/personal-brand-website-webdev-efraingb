    ...
    <section id="hero" className="relative py-20 md:py-32 min-h-[calc(100vh-4rem)] flex items-center justify-center overflow-hidden">
      ...
      <div className="container relative z-10 text-center px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-5xl sm:text-6xl md:text-7xl font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-primary to-accent animate-fade-in-up opacity-0 delay-100">
            Efraín G.B.
          </h1>
          <p className="mt-6 text-xl sm:text-2xl md:text-3xl font-medium text-foreground/90 animate-fade-in-up opacity-0 delay-300">
            Full-Stack Developer & AI Innovator
          </p>
          <p className="mt-8 text-lg text-foreground/70 leading-relaxed animate-fade-in-up opacity-0 delay-500">
          ...
          <div className="mt-12 flex flex-col sm:flex-row gap-4 justify-center animate-fade-in-up opacity-0 delay-700">
